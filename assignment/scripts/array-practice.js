...
let favoriteFoods = ['tacos', 'burritos', 'steak'];
...
favoriteFoods.push('peach cobbler');
...
favoriteFoods.unshift('steamed broccoli');
...
console.log('My favorite foods in reverse alphabetical order:',favoriteFoods);
